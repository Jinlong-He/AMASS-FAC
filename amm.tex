...
For example, an implicit intent with the action ``ACTION\_VIEW'' and the data of \revision{a} URI ``http://www.google.com'' will cause a web browser to open a webpage. 
