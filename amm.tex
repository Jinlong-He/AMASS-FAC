...
%
We use two simple apps from F-Droid, namely, LaunchTime Homescreen\footnote{available at https://github.com/quaap/LaunchTime/blob/master/} and ShoppingList\footnote{available at https://github.com/GroundApps/ShoppingList/blob/master/}, to motivate this work. 
%
\subsubsection{The ``LaunchTime Homescreen'' app}
...
\end{itemize}
From this example, we can see that the {\AMASS} model contains more information about activities than the well-known ATG model and the model in \cite{LHR17}, thus enables a more accurate analysis of the task unboundedness problem. 
