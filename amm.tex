...
%
\revision{\subsection{The ``LaunchTime Homescreen'' app: A motivating example for accurate modeling of factors of activities}}
...
%
\revision{\subsection{The ``ShoppingList'' app: A motivating example for accurate modeling of factors of fragments}}
