...
%
Namely, 14 out of 74 apps (around 19\%) apps end up with the abnormal behaviors which shows that, compared to the random testing, the repeated executions of witness cycles indeed dramatically increase the chances of exposing the abnormal behaviors. As a result, we believe there is a causal relation between the task unboundedness/fragment-container unboundedness and the abnormal behaviors of Android apps. It suggests that task-unbounded/fragment-container unbounded apps can be potentially harmful to
